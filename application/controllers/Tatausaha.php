...
class Tatausaha extends CI_Controller {
    ...
    public function index(){
		...
		$this->load->view('tatausaha/tatausaha_v',$data);
	}
    ...
    public function formBerita(){
		...
		$this->load->view('tatausaha/formBerita_v',$data);
	}
    ...
    public function tabelBerita(){
        $data['berita'] = $this->login_m->getAllBeritaTU();
		$where = array(
						'idAdmin' => $this->session->userdata("idAdmin")
						);
		$data['admin']=$this->login_m->ambilData($this->tabelAdmin,$where);
		$this->load->view('tatausaha/tabelBerita_v',$data);
	}
    ...
    public function grafik(){
		...
		$data['admin']=$this->login_m->ambilData($this->tabelAdmin,$where);
		$this->load->view('tatausaha/grafik_v',$data);
	}
    ...
    function simpanBerita(){
        ...
        redirect('tatausaha/tabelBerita');
		 }
    ...
    function aksiUpdateBerita($id){
        ...
        $this->load->view('tatausaha/formEditBerita_v',$data);
    }
