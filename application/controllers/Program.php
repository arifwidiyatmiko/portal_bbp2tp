...
class Program extends CI_Controller {
    ...
    public function index(){
		...
		$this->load->view('program/program_v',$data);
	}
    ...
    public function formBerita(){
		...
		$this->load->view('program/formBerita_v',$data);
	}
    ...
    public function tabelBerita(){
        $data['berita'] = $this->login_m->getAllBeritaProgram();
		$where = array(
						'idAdmin' => $this->session->userdata("idAdmin")
						);
		$data['admin']=$this->login_m->ambilData($this->tabelAdmin,$where);
		$this->load->view('program/tabelBerita_v',$data);
	}
    ...
    public function grafik(){
		...
		$data['admin']=$this->login_m->ambilData($this->tabelAdmin,$where);
		$this->load->view('program/grafik_v',$data);
	}
    ...
    function aksiUpdateBerita($id){
        ...
        $this->load->view('program/formEditBerita_v',$data);
    }
