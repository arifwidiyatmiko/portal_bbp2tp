...
class Ksphp extends CI_Controller {
    ...
    public function index(){
		...
		$this->load->view('ksphp/ksphp_v',$data);
	}
    ...
    public function formBerita(){
		...
		$this->load->view('ksphp/formBerita_v',$data);
	}
    ...
    public function tabelBerita(){
        $data['berita'] = $this->login_m->getAllBeritaKsphp();
		$where = array(
						'idAdmin' => $this->session->userdata("idAdmin")
						);
		$data['admin']=$this->login_m->ambilData($this->tabelAdmin,$where);
		$this->load->view('ksphp/tabelBerita_v',$data);
	}
    ...
    public function grafik(){
		...
		$data['admin']=$this->login_m->ambilData($this->tabelAdmin,$where);
		$this->load->view('ksphp/grafik_v',$data);
	}
    ...
    function aksiUpdateBerita($id){
        ...
        $this->load->view('ksphp/formEditBerita_v',$data);
    }
