                ...
                <div class="row">
                    <div class="col-md-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Tabel Kegiatan</li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <div class="form form-inline ">
                                   <a href="" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#tambahKomoditas">Tambah Kegiatan</a>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                           <?php
                                            ...
                                            <tr>
                                                <td><?php echo $no;?></td>
                                                <td><?php echo $b->namaKegiatan;?></td>
                                                <td>
                                                    <a data-href="<?=base_url()?>Dashboard/delete_kegiatan/<?=$b->idKegiatan?>" data-nama="<?=$b->namaKegiatan?>" data-toggle="modal" data-target="#hapusKegiatan" class="btn btn-sm btn-danger">Hapus</a>
                                                    <a data-nama="<?=$b->namaKegiatan?>" data-id="<?=base_url()?>Dashboard/edit_kegiatan/<?=$b->idKegiatan?>" class="btn btn-sm btn-info" data-toggle="modal" data-target="#editKomoditas">Edit</a>
                                                </td>
                                            </tr>
                                            <?php 
                                            $no++;
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- <div class="container"> -->
            <form action="<?= base_url();?>Dashboard/add_kegiatan" method="POST">
...
<div id="hapusKegiatan" class="modal fade" role="dialog">
    <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Hapus Kegiatan : <b><span id="namaKomoditas_lm1"></span></b></h4>
      </div>
