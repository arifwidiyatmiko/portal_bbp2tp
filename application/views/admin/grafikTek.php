...
Highcharts.chart('chart-container', {
    ...
    title: {
        text: 'Grafik Jumlah Penggunaan Teknologi Setiap Provinsi'
    },
    subtitle: {
        text: 'Klik salah satu batang untuk melihat penggunaan teknologi.'
    },
    xAxis: {
        type: 'category'
    },
    yAxis: {
        title: {
            text: 'Jumlah Teknologi yang Digunakan'
        }
    ...
    "drilldown": {
        ...
        function changeChart(datas,seriess) {
            Highcharts.chart('chart-container', {
                chart: {
                    type: 'column'
                },
        ...
        $('#kurunWaktu').on('change',function() {
            $.ajax({
                        type : "GET",
                        url : "<?php echo base_url(); ?>Json/grafikTek/"+$('#kurunWaktu').val(),
                        // data : "cmbSubsektor=" + ,
                        success: function(data){
                            changeChart(data.data,data.series);
                        }
                    });
        })
          </script>
