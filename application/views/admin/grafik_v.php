      ...
      var chart = new FusionCharts(
          {
            ...
            "height":"300",
            "dataFormat":"jsonurl",
            "dataSource":"<?php echo site_url('dashboard/json');?>"
          }
          );
          chart.render();
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#" class="active-menu"><i class="fa fa-bar-chart-o fa-2x"></i> Grafik</a>
                    </li>
                    <!-- <li>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <center>
                                                ...
                                                <!-- <?php echo form_open('dashboard/json'); ?>
                                                <select name="fbulan" id="fbulan">
                                                    <option value="">-- Pilih Bulan --</option>
                                                    <option value="03">Januari</option>
                                                    <option value="04">Januari</option>
                                                </select> -->
                                                Tipe Grafik : 
                                                <select id="type">
                                                    <option value="column2d"> Batang 2D </option>
                                                    <option value="column3d"> Batang 3D </option>
                                                    <option value="bar2d"> Bar 2D </option>
                                                    <option value="bar3d"> Bar 3D </option>
                                                    <option value="line"> Garis </option>
                                                    <option value="area2d"> Area 2D </option>
                                                    <option value="doughnut2d"> Donat 2D </option>
                                                    <option value="doughnut3d"> Donat 3D </option>
