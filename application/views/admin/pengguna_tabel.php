                ...
                <div class="row">
                    <div class="col-md-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Tabel Pengguna</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <h4 class="col-md-10">Tabel Kegiatan</h4>
                            <div class="panel-heading">
                                <div class="form form-inline ">
                                   <a href="" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#tambahKomoditas">Tambah Pengguna</a>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                           <?php
                                            ...
                                            <tr>
                                                <td><?php echo $no;?></td>
                                                <td><?php echo $b->namaPengguna;?></td>
                                                <td>
                                                    <?php
                                                    if ($no !=1) {
                                                        ?><a data-href="<?=base_url()?>Dashboard/pengguna/delete/<?=$b->idAdmin?>" data-nama="<?=$b->namaPengguna?>" data-toggle="modal" data-target="#hapusPengguna" class="btn btn-sm btn-danger">Hapus</a><?php
                                                    }
                                                    ?>
                                                    <a data-nama="<?=$b->namaPengguna?>" data-id="<?=base_url()?>Dashboard/pengguna/edit/<?=$b->idAdmin?>" data-pass="<?=$b->kataSandi?>" class="btn btn-sm btn-info" data-toggle="modal" data-target="#editPengguna">Edit</a>
                                                </td>
                                            </tr>
                                            <?php 
                                            $no++;
    ...
    <script type="text/javascript">
        // dataTables-example
         $(document).ready(function() {
            ...
            $('#editPengguna').on('show.bs.modal', function(e) {
                // alert('sda');
                $('#t_password').val($(e.relatedTarget).data('pass'));
                $('#t_namaPengguna').val($(e.relatedTarget).data('nama'));
                $('#namaKomoditas_lms').text($(e.relatedTarget).data('nama'));
                $('#form-edit').attr('action', $(e.relatedTarget).data('id'));
            });
            $('#hapusPengguna').on('show.bs.modal', function(e) {
                // alert('sda');
                $(this).find('.btn-ok').attr('action', $(e.relatedTarget).data('id'));
                $('#namaKomoditas_lm1').text($(e.relatedTarget).data('nama'));
                // $('#form-edit').attr('action', $(e.relatedTarget).data('id'));
            });
        });
    </script>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- <div class="container"> -->
            <form action="<?= base_url();?>Dashboard/pengguna/add" method="POST">
                
                <div class="form-group">
                    <label>Nama Pengguna <span style="color: red;">Tanpa Spasi</span></label>
                    <input type="text" name="namaPengguna"  class="form-control" placeholder="Nama pengguna">
                </div>
                <div class="form-group">
                    <label>Password <span style="color: red;">Tanpa Spasi,Min. 4 Digit</span></label>
...
<div id="editPengguna" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Edit Pengguna : <span id="namaKomoditas_lms"></span></h4>
      </div>
      <div class="modal-body">
        <!-- <div class="container"> -->
            <form  method="POST"  id="form-edit">
                <div class="form-group">
                    <label>Nama Pengguna <span style="color: red;">Tanpa Spasi</span></label>
                    <input type="text" name="namaPengguna" id="t_namaPengguna" class="form-control" placeholder="Nama pengguna">
                </div>
                <div class="form-group">
                    <label>Password <span style="color: red;">Tanpa Spasi,Min. 4 Digit</span></label>
                    <input type="password" name="password" id="t_password" class="form-control" placeholder="Password">
                </div>
                <input type="submit" class="btn btn-primary">
            </form>
        <!-- </div> -->
...
<div id="hapusPengguna" class="modal fade" role="dialog">
    <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Hapus Pengguna : <b><span id="namaKomoditas_lm1"></span></b></h4>
      </div>
