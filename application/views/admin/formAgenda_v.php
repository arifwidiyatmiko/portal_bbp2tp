                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>dashboard/tabelAgenda">Komoditas</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="<?php echo base_url().'dashboard/simpanAgenda'?>" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label>Judul Agenda</label>
                                                <input type="text" class="form-control" name="fjudul" placeholder="Judul Agenda" required/>
                                            </div>
                                            <div class="form-group">
                                                <label>Tempat</label>
                                                <input type="text" class="form-control" name="ftempat" placeholder="Tempat" required/>
                                            </div>
                                            <div class="form-group">
                                                <label>Tanggal</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="fpeserta" placeholder="Jumlah Peserta" required />
                                            </div>
                                            <div class="form-group">
                                                <label>Tamu VIP</label>
                                                <input type="text" class="form-control" name="ftamuVIP" placeholder="Tamu VIP" required/>
                                            </div>
                                            <div class="form-group">
                                                <label>Penanggung Jawab</label>
                                                <input type="text" class="form-control" name="fpjKegiatan" placeholder="Penanggung Jawab" required/>
                                            </div>
                                            <div class="form-group">
