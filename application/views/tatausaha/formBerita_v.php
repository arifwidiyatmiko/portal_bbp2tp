        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>tatausaha/formBerita" class="active-menu"><i class="fa fa-edit fa-2x"></i> Formulir Berita</a>
                    </li>
                    <li>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php echo form_open_multipart('tatausaha/simpanBerita'); ?>
                                        <?php   foreach ($admin->result() as $key) { ?>
