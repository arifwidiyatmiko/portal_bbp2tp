        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>program/formBerita" class="active-menu"><i class="fa fa-edit fa-2x"></i> Formulir Berita</a>
                    </li>
                    <li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <!-- <form action="<?php echo base_url().'program/simpanBerita'?>" method="post" enctype="multipart/form-data"> -->
                                        <?php echo form_open_multipart('program/simpanBerita'); ?>
                                        <?php   foreach ($admin->result() as $key) { ?>
