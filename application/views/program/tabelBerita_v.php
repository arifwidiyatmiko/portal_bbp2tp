    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>program"><img src="<?php echo base_url(); ?>assets/home/img/brandtext2.png"></a>
            </div>
            ...
            <div style="color: white; padding: 15px 50px 5px 50px; float: right; font-size: 16px;">
                <?php echo $key->nama ?>&nbsp;
                <a href="<?php echo site_url('program/logout'); ?>" class="btn btn-danger square-btn-adjust">Logout</a>
            </div>
        </nav>
        <?php } ?>
        <!-- /. NAV TOP  -->
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        <a href="<?php echo base_url(); ?>program"><i class="glyphicon glyphicon-home fa-2x"></i> Beranda</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>program/formBerita"><i class="fa fa-edit fa-2x"></i> Formulir Berita</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>program/tabelBerita" class="active-menu"><i class="fa fa-table fa-2x"></i> Tabel Berita</a>
                    </li>
                    <!-- <li>
                        <a   href="<?php echo base_url(); ?>program/grafik"><i class="fa fa-bar-chart-o fa-2x"></i> Grafik</a>
                    </li> -->
                    <!-- <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ol class="breadcrumb">
                            <li><a href="<?php echo base_url(); ?>program">Beranda</a></li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <div class="form form-inline ">
                                    <button type="button" name="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary"><a href="<?php echo base_url(); ?>program/formBerita" style="color: #fff;"><div class="glyphicon glyphicon-plus"></div> Tambah Berita</a></button>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                           <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo site_url('program/aksiUpdateBerita/'.$idBerita) ?>" type="button" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                                    <a href="<?php echo site_url('program/aksiDelBerita/'.$idBerita) ?>" class="btn btn-danger" onClick="return confirm('Yakin ingin menghapus berita ini?')"><i class="glyphicon glyphicon-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php 
                                            $no++;
