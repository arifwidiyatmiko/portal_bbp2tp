        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>program/tabelBerita"><i class="fa fa-table fa-2x"></i> Tabel Berita</a>
                    </li>
                    <!-- <li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <!-- <form action="<?php echo site_url('program/aksiAfterEditBerita') ?>" method="post" enctype="multipart/form-data"> -->
                                        <?php echo form_open_multipart('program/aksiAfterEditBerita');
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="fisi" id="ckeditor" placeholder="Isi Berita" required><?php echo $isiBerita ?></textarea>
                                            <!-- <span id="hitung">1000</span> Karakter tersisa -->
                                        </div>
                                        <div class="form-group">
