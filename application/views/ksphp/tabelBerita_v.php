        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>ksphp/formBerita"><i class="fa fa-edit fa-2x"></i> Formulir Berita</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>ksphp/tabelBerita" class="active-menu"><i class="fa fa-table fa-2x"></i> Tabel Berita</a>
                    </li>
                    <!-- <li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <div class="form form-inline ">
                                    <button type="button" name="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary"><a href="<?php echo base_url(); ?>ksphp/formBerita" style="color: #fff;"><div class="glyphicon glyphicon-plus"></div> Tambah Berita</a></button>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                           <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo site_url('ksphp/aksiUpdateBerita/'.$idBerita) ?>" type="button" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                                    <a href="<?php echo site_url('ksphp/aksiDelBerita/'.$idBerita) ?>" class="btn btn-danger" onClick="return confirm('Yakin ingin menghapus berita ini?')"><i class="glyphicon glyphicon-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php 
                                            $no++;
